...
//-----------------------------------------------------------------------------------
#define FIREBASE_HOST "proje-360702-default-rtdb.firebaseio.com"
#define FIREBASE_AUTH "ToWGOIrT3fHN08BixeIzimL0Gzt6GYdNVZ77Jfbp"
#define WIFI_SSID "akrem"
#define WIFI_PASSWORD "akrem1234"
//-----------------------------------------------------------------------------------
...
FirebaseData firebaseDataBUZZER;
...
//MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
void loop() {
if (Firebase.getInt(firebaseDataBUZZER, "/buzzer/buzzerValue")==10) {
     tone(D5,4000,500);
  }   
 rawData = analogRead(ldrPin); 
  smartdelay_gps(1000);
 if(Firebase.setInt(firebaseData, "/LDR/LDR_Value", rawData))
      {print_ok();
...
void print_ok()
{
    ...
    Serial.println("ETag: " + firebaseData.ETag());
     ...
     Serial.println("Lumiére : " + rawData); 
